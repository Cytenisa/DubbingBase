...
final class Version20230912094535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE dubbing_id_seq CASCADE');
        ...
        $this->addSql('CREATE TABLE account (id INT NOT NULL, ac_login VARCHAR(255) NOT NULL, ac_idtrakt VARCHAR(255) DEFAULT NULL, ac_pwd VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE dubbing_movie (id INT NOT NULL, id_lc_code_id INT DEFAULT NULL, id_vaidactor_id INT DEFAULT NULL, tmdb_id_actor INT NOT NULL, tmdb_id_movie INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE dubbing_serie (id INT NOT NULL, id_lc_code_id INT DEFAULT NULL, id_vaidactor_id INT DEFAULT NULL, tmdb_id_actor INT NOT NULL, tmdb_id_serie INT NOT NULL, tmdb_season_number_start INT NOT NULL, tmdb_season_number_end INT NOT NULL, tmdb_episode_number_start INT NOT NULL, tmdb_episode_number_end INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE locale (id INT NOT NULL, lc_code VARCHAR(255) NOT NULL, lc_label VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE voice_actor (id INT NOT NULL, va_lastname VARCHAR(255) NOT NULL, va_firstname VARCHAR(255) NOT NULL, va_birthdate DATE DEFAULT NULL, va_nationality VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE dubbing_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
